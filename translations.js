const translations = {
    en: {
        ...
        feature1Title: "PMI Compliant Enterprise Governance",
        feature1Desc: "International project management standards with complete compatibility. An infrastructure covering Integration, Scope, Time, Cost, Quality, Resource, Communication, Risk, Procurement, and Stakeholder management — all under one roof, faithful to methodology.",
        feature2Title: "AI-Powered Decision Support",
        feature2Desc: "The platform doesn't just collect data, it analyzes and alerts you. It detects project risks in advance, flags performance anomalies, recommends resource optimization. Executives make decisions with insights, not data.",
        feature3Title: "Role, Permission & Security Management",
        feature3Desc: "Create sophisticated access control with unit, role, and user-based permissions. Control who sees what, who can edit what — customize your entire access hierarchy to match your organizational structure.",
        feature4Title: "Real-Time Collaboration",
        feature4Desc: "With integrated video conferencing, instant messaging, and live activity feeds, teams never need to switch tools. Every discussion, every decision, every update — all in project context, on the same screen.",
        feature5Title: "Universal Integration Infrastructure",
        feature5Desc: "Connect to your existing ERP systems, Supply Management Portals, and Active Directory infrastructure via REST Web Services. MVP FACTORY doesn't invalidate your organization's existing technology investments — it strengthens them.",
        ...
        infoRequest: "For detailed information about other modules, please contact <a href='mailto:info@roket.info' style='color: #2B70B3; text-decoration: none;'>info@roket.info</a>.",
    ...
    tr: {
        ...
        infoRequest: "Diğer modüller hakkında ayrıntı bilgi için lütfen <a href='mailto:info@roket.info' style='color: #2B70B3; text-decoration: none;'>info@roket.info</a> adresine yazınız.",
